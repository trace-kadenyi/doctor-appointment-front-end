...
import { fetchCreateUser, fetchUsers, selectUsers, setCurrentUser } from "../Redux/UserReducer"
...
function User() {
  ...
  const loginUser = (name) => {
    let currentUser = users.filter(e => e.name ==  name);
  ...
  return (
    ...
    <form>
      ...
      <div>
        <input id="username-input" placeholder= "enter your username" onChange={ (e) => setUsername(e.target.value)}></input><br></br>
